...
public class WebDriverUtility{
		...
		{
			WebDriverWait wait = new WebDriverWait(driver, IPathConstants.timeforexplicitwait);
		...
		{
			driver.manage().timeouts().implicitlyWait(IPathConstants.timeforimplicitwait,TimeUnit.SECONDS);
		}
		/**
