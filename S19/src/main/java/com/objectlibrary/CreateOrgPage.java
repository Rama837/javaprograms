...
public class CreateOrgPage 
{
	...
	@FindBy(name="accounttype")	private WebElement type;
	
	@FindBy(name="rating")	private WebElement rating;
	
	@FindBy(xpath="//input[@title='Save [Alt+S]']")	private WebElement saveorgbtn;
